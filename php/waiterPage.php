...
<head>
    ...
    <title>Waiter</title>
    <link rel="stylesheet" type="text/css" href="../css/waiterPageCss.css">
    ...
    <header>
            ...
            <div class="container">
                ...
                <nav>
                    ...
                    ?>
                    <br>
                    <a href="" class="navAI">In-house Order</a>
                    <a href="waiterPageOnline.php" class="navAO">Online Order</a>
                </nav>

            </div>
    </header>
        <div class="row">
                    <form action="createOrder.php" method="post" style="text-align:center; margin-top:20px;">
                        </select>
                        ...
                        <label style="margin-left:20px;">Customer Email<span class="greenAcc">:</span> </label>
                        <input type="text" name="cusEmail" style="margin-right:20px;">
                        
                        <?php $_SESSION["typeI"] = "in-house"; ?>
                    
                        <input type="submit" value="Make Order" style="margin-left:20px; border: none; padding: 4px;" class="bg-success rounded text-white">
        ...
        <?php
            if(isset($_SESSION["orderIdI"]))
            {
                $orderId = $_SESSION["orderIdI"];
        ?>
                        ...
                        <table class="table table-success table-striped">
                                ...
                                <?php 
                                        ...
                                        while($row = mysqli_fetch_array($result)){
                                            ...
                                            ?>
                                            <tr>
                                                <td><b><?php echo"$itemId"; ?></b></td>
                                                <td><?php echo"$itemName"; ?></td>
                                                <td><?php echo"$itemPrice"; ?></td>
                                                <td><form action='addItem.php?orderId=<?php echo "$orderId"; ?>' method="post">
                        ...
                        <div class="col-sm-6">
                                    ...
                                    <?php 
                                            ...
                                            while($row = mysqli_fetch_array($result)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><form action='updateStatusItem.php' method="post">
                            ...
                            <div class="row" style="margin-top:15px; text-align: center;">
                               ...
                               <?php
                                ...
                                <form action='updateStatusOrder.php' method="post">
